...
const OurProduct = () => {
    return (
        <div className='pt-10 lg:pt-12 px-1 md:px-0' id='product' >
            ...
            <div className='mt-5 md:mt-8 grid grid-cols-2 md:grid-cols-3 gap-1 md:gap-2'>
                <div className="card card-compact w-full bg-base-100 shadow-xl">
                    <figure><img className='w-full h-36 md:h-52' src={img1} alt="Shoes" /></figure>
                    <div className="card-body text-left">
                        <h2 className="card-title">Handle Bag</h2>
                        <p className='text-start'>This is the best quality tissue bag that is available in the market. Get this product from us right now.</p>
                        ...
                        <div><span className='font-semibold'>Price:</span> tk</div>
                    </div>
                </div>
                ...
                <div className="card card-compact w-full bg-base-100 shadow-xl">
                    ...
                    <div className="card-body text-left">
                        <h2 className="card-title">D-Cut Bag</h2>
                        <p className='text-start'>This is the best quality tissue bag that is available in the market. Get this product from us right now.</p>
                        <div className='flex items-center gap-2'>
                            <p className='font-semibold'>Sizes:</p>
                            <p className='border flex justify-center py-1 hover:bg-slate-300 border-slate-300'>S</p>
                ...
                <div className="card card-compact w-full bg-base-100 shadow-xl">
                    ...
                    <div className="card-body text-left">
                        <h2 className="card-title">Auto Box bag</h2>
                        <p className='text-start'>This is the best quality tissue bag that is available in the market. Get this product from us right now.</p>
                        <div className='flex items-center gap-2'>
                            <p className='font-semibold'>Sizes:</p>
                            <p className='border flex justify-center py-1 hover:bg-slate-300 border-slate-300'>S</p>
                ...
                <div className="card card-compact w-full bg-base-100 shadow-xl">
                    ...
                    <div className="card-body text-left">
                        <h2 className="card-title">Printing Bag</h2>
                        <p className='text-start'>This is the best quality tissue bag that is available in the market. Get this product from us right now.</p>
                        <div className='flex items-center gap-2'>
                            <p className='font-semibold'>Sizes:</p>
                            <p className='border flex justify-center py-1 hover:bg-slate-300 border-slate-300'>S</p>
                ...
                <div className="card card-compact w-full bg-base-100 shadow-xl">
                    ...
                    <div className="card-body text-left">
                        <h2 className="card-title">W-Cut Bag</h2>
                        <p className='text-start'>This is the best quality tissue bag that is available in the market. Get this product from us right now.</p>
                        <div className='flex items-center gap-2'>
                            <p className='font-semibold'>Sizes:</p>
                            <p className='border flex justify-center py-1 hover:bg-slate-300 border-slate-300'>S</p>
